...
public:
	...
	cl_bool setArguments(cl_uint indexKernel, cl_uint * indicesMemoryBuffer, cl_uint numberIndicesMemoryBuffer, void * arguments, cl_char * typeArgubents, cl_uint numberArguments);
	cl_bool startCalculate(cl_uint indexKernel, size_t globalWork[3]);
	cl_bool readData(void ** returnedData, cl_uint * indicesReadData, cl_char * typeArgubentsReturnedData, cl_ulong * lengthWrite, cl_uint numberIndicesReadData);
