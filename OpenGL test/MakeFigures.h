...
{
	volatile size_t* makeField(OpenGL_API::GraphicsOpenGL* mainGL, float x_near, float x_far, float y_near, float y_far, float z_near, float z_far, float x_step, float y_step, float z_step);
